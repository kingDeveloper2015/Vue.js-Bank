                ...
                <div class="create">
                    ...
                    <form v-on:submit.prevent="addProfile">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" v-model="credit_modal.assessed_value" id="AV" required>
                        </div>

                        <div class="form-group">
                            <label name="credit_name">FV</label>
                            <input type="number" class="form-control" v-model="credit_modal.full_value" id="FV" required>
                        </div>
                        <div class="form-group">
                            <label name="credit_name">TGT</label>
                            <input type="number" class="form-control" v-model="credit_modal.total_go_debt" id="TGT" required>
                        </div>
                        <div class="form-group">
                            <label name="credit_name">TRD</label>
                            <input type="number" class="form-control" v-model="credit_modal.total_revenue_debt" id="TRD" required>
                        </div>

                        <div class="form-group">
                            <label name="credit_name">TDL</label>
                            <input type="number" class="form-control" v-model="credit_modal.total_debt_limit" id="TDL" >
                        </div>
                        <div class="form-group">
                            <label name="credit_name">TDD</label>
                            <input type="number" class="form-control" v-model="credit_modal.total_direct_debt" id="TDD" >
                        </div>
            ...
            lambda.invoke(pullParams, function(error,data) {
                if ( error) {
                    ...
                    if ( window.method == "create") {
                        $this.$root.$data.all_data.GO_debt_profile.push($this.credit_modal);
                    } else {
