                ...
                <div class="create">
                    ...
                    <form v-on:submit.prevent="addProfile">
					    ...
					    <div class="form-group">
					        ...
					        <input type="text" class="form-control" v-model="credit_modal.aggregate_revenues" id="AR" required>
					    </div>

					    <div class="form-group">
					        <label name="credit_name">AE</label>
					        <input type="text" class="form-control" v-model="credit_modal.aggregate_expenses" id="AE" required>
					    </div>
					    <div class="form-group">
					        <label name="credit_name">ACP</label>
					        <input type="text" class="form-control" v-model="credit_modal.aggregate_change_net_position" id="ACP" required>
					    </div>
					    <div class="form-group">
            ...
            lambda.invoke(pullParams, function(error,data) {
                if ( error) {
                    ...
                    if ( window.method == "create") {
                        $this.$root.$data.all_data.GO_statement_activity.push($this.credit_modal);
                    } else {
