            ...
            <slot name="body">
                <div class="create">
                    <form v-on:submit.prevent="addProfile">
                        ...
                        <div class="form-group">
                            <label name="credit_name">FVPC</label>
                            <input type="text" class="form-control" v-model="credit_modal.full_value_per_capita" id="FVPC" required>
                        </div>

                        <div class="form-group">
                            <label name="credit_name">DDPC</label>
                            <input type="text" class="form-control" v-model="credit_modal.direct_debt_per_capita" id="DDPC" required>
                        </div>
                        <div class="form-group">
                            <label name="credit_name">DDFV</label>
                            <input type="text" class="form-control" v-model="credit_modal.direct_debt_full_value" id="DDFV" required>
                        </div>
                        <div class="form-group">
            ...
            lambda.invoke(pullParams, function(error,data) {
                if ( error) {
                    ...
                    if ( window.method == "create") {
                        $this.$root.$data.all_data.GO_ratios.push($this.credit_modal);
                    } else {
