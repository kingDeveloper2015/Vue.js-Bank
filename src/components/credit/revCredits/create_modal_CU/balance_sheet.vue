                ...
                <div class="create">
                    ...
                    <form v-on:submit.prevent="addProfile">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="credit_modal.cash" id="Cash" >
                        </div>

                        <div class="form-group">
                            <label name="credit_name">CA</label>
                            <input type="text" class="form-control" v-model="credit_modal.current_assets" id="CA" >
                        </div>
                        <div class="form-group">
                            <label name="credit_name">CAS</label>
                            <input type="text" class="form-control" v-model="credit_modal.capital_assets" id="CAS" >
                        </div>
                        <div class="form-group">
                            <label name="credit_name">TS</label>
                            <input type="text" class="form-control" v-model="credit_modal.total_assets" id="TS" >
                        </div>
                        <div class="form-group">
                            <label name="credit_name">CL</label>
                            <input type="text" class="form-control" v-model="credit_modal.current_ltd" id="CL" >
                        </div>

                        <div class="form-group">
                            <label name="credit_name">CUL</label>
                            <input type="text" class="form-control" v-model="credit_modal.current_liabilities" id="CUL" >
                        </div>

                        <div class="form-group">
                            <label name="credit_name">LTD</label>
                            <input type="text" class="form-control" v-model="credit_modal.long_term_debt" id="LTD" >
                        </div>
                        <div class="form-group">
                            <label name="credit_name">TL</label>
                            <input type="text" class="form-control" v-model="credit_modal.total_liabilities" id="TL" >
                        </div>

                        <div class="form-group">
                            <label name="credit_name">RNS</label>
                            <input type="text" class="form-control" v-model="credit_modal.restricted_net_assets" id="RNS" >
                        </div>
                        <div class="form-group">
                            <label name="credit_name">UNS</label>
                            <input type="text" class="form-control" v-model="credit_modal.unrestricted_net_assets" id="UNS" >
                        </div>

                        <div class="form-group">
                            <label name="credit_name">NCA</label>
                            <input type="text" class="form-control" v-model="credit_modal.net_capital_assets" id="NCA" >
                        </div>
                        <div class="form-group">
                            <label name="credit_name">TNS</label>
                            <input type="text" class="form-control" v-model="credit_modal.total_net_assets" id="TNS" >
                        </div>
            ...
            lambda.invoke(pullParams, function(error,data) {
                if ( error) {
                    ...
                    if ( window.method == "create") {
                        $this.$root.$data.all_data.Revenue_balance_sheet.push($this.credit_modal);
                    } else {
